    ...
    return Scaffold(
      appBar: CustomStackAppBar(
        ...
        onInfo: () {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => InsertHba1c()),
          );
        },
      ),
      ...
      body: BlocBuilder<Hba1cCubit, Hba1cState>(
        builder: (context, state) {
          if (state is Hba1cLoading) {
            ...
            final filteredRecords = filterByStatus(
              hba1cRecords,
            ); // Dữ liệu đã lọc cho card
            final chartFilteredData = filterChartData(
              hba1cRecords,
            ); // Dữ liệu đã lọc cho chart
                ...
                children: [
                  Padding(
                    ...
                    child: SizedBox(
                      ...
                      child: Hba1cChart(
                        data:
                            chartFilteredData, // Sử dụng dữ liệu đã lọc cho chart
                        onFilterTap: () {
            ...
            Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    Text(
                      '${hbA1c.date.day.toString().padLeft(2, "0")}/${hbA1c.date.month}/${hbA1c.date.year}',
                      style: TextStyle(
                    ...
                    Gap(5),
                    Text(
                      '${hbA1c.date.hour}:${hbA1c.date.minute.toString().padLeft(2, '0')}',
                      style: TextStyle(
                        color: Colors.grey.shade600,
                        fontSize: 12,
                      ),
